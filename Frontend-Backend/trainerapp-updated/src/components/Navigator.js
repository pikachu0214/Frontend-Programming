      ...
      <div className="container-fluid">
        <nav className="navbar navbar-expand-lg navbar-light bg-primary">
          <Link className="navbar-brand" to="/">
            <svg width="24" height="100" fill="red" >
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <img
              src={require("../img/swimmingpool.jpg")}
              width="100"
              height="100"
              alt=""
            />
            ...
            <img
              src={require("../img/weights1.jpg")}
              width="100"
              height="100"
              alt=""
            />
            <img
              src={require("../img/weights2.jpg")}
              width="100"
              height="100"
              alt=""
            />
            <p className="lead">
              Our Yoga instructor is one of the best in the world. Contact us
              for an appointment.
            </p>
            <hr className="my-4" />
            <p>
              We have a basketball court, sauna, and swimming pool and tennis
              court. Start today.
            </p>
