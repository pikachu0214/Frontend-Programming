    ...
    return <div className="container-fluid">
        <nav className="navbar navbar-expand-lg navbar-light bg-primary">
          <Link className="navbar-brand" to="/">
            <svg width="24" height="100" fill="red" clip-rule="evenodd">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <img src={require("../img/cardio.jpg")} width="100" height="100" />
            <img src={require("../img/cardio1.jpg")} width="100" height="100" />
            <img src={require("../img/swimmingpool.jpg")} width="100" height="100" />
            <img src={require("../img/weights.jpg")} width="100" height="100" />
            <img src={require("../img/weights1.jpg")} width="100" height="100" />
            <img src={require("../img/weights2.jpg")} width="100" height="100" />
            <p className="lead">
              Our Yoga instructor is one of the best in the world. Contact
